    ...
    const columns = [
        {
            ...
            render: function (key) {
                return `
                    <span data-key="${key}">
                        <a href="/admin/order/savedata?id=${key}" title="Edit"><i class="fas fa-pencil-alt"></i></a> &nbsp;
                        <a href="#" class="btn-delete" title="Delete"><i class="fas fa-trash"></i></a> &nbsp;
                        <a href="/admin/report/ExportPdfOrder?id=${key}" title="Export report"><i class="fas fa-arrow-alt-circle-down"></i> </a>
                    </span>
                `;
            }
        },
